...
def mainProgram():
    '''
Explanation:
This is the starting function for the rest of my program. It controlls the execution of every other function I've written and directs the calls to my other functions.
It is also connected to the if __name__== "__main__": line at the bottom of the program, which tells python what to run and executes the program.
    '''
    while True: 
        try:
            if not unique_list:
